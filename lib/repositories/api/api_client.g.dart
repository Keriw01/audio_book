...
class _ApiClient implements ApiClient {
  ...
  Future<TokenModel> login({
    ...
    final _result = await _dio
      ...
      contentType: 'application/x-www-form-urlencoded',
            ...
            .compose(
              _dio.options,
              'http://audiobookhsetvo.mooo.com///api/audio_book.php/login',
  ...
  Future<TokenModel> registration({
    ...
    final _result = await _dio
      ...
      contentType: 'application/x-www-form-urlencoded',
            ...
            .compose(
              _dio.options,
              'http://audiobookhsetvo.mooo.com///api/audio_book.php/registration',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<TokenModel> refreshToken({
    ...
    final _result = await _dio
      ...
      contentType: 'application/x-www-form-urlencoded',
            ...
            .compose(
              _dio.options,
              'http://audiobookhsetvo.mooo.com///api/audio_book.php/refresh-token',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<User> getUserId({required String accessToken}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://audiobookhsetvo.mooo.com///api/audio_book.php/user',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
